...
static void
copy_and_encode(lzma_delta_coder* coder, const uint8_t* restrict in, uint8_t* restrict out, size_t size) {
...
static lzma_ret
delta_encoder_update(void* coder_ptr,
                     const lzma_allocator* allocator,
...
extern lzma_ret
lzma_delta_encoder_init(lzma_next_coder* next, const lzma_allocator* allocator, const lzma_filter_info* filters) {
