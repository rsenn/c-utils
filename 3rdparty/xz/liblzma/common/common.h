...
#define LZMA_SUPPORTED_FLAGS                                                                                           \
  (LZMA_TELL_NO_CHECK | LZMA_TELL_UNSUPPORTED_CHECK | LZMA_TELL_ANY_CHECK | LZMA_IGNORE_CHECK | LZMA_CONCATENATED)
...
/// function prototype.
typedef lzma_ret (*lzma_code_function)(void* coder,
                                       const lzma_allocator* allocator,
...
/// Allocates memory
extern void* lzma_alloc(size_t size, const lzma_allocator* allocator) lzma_attribute((__malloc__))
...
extern size_t lzma_bufcpy(const uint8_t* restrict in,
                          size_t* restrict in_pos,
                          size_t in_size,
                          uint8_t* restrict out,
                          size_t* restrict out_pos,
