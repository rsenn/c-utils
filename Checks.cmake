...
try_compile( HAVE_IOPAUSE ${CMAKE_CURRENT_BINARY_DIR} SOURCES "${CMAKE_CURRENT_BINARY_DIR}/trypoll.c" )
if( HAVE_IOPAUSE )
file( WRITE "${CMAKE_BINARY_DIR}/iopause.h" "")
endif( HAVE_IOPAUSE )
...
if( HAVE_SELECT )
file( WRITE "${CMAKE_BINARY_DIR}/select.h" "")
endif( HAVE_SELECT )
