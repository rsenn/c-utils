...
if (BZIP2_FOUND)
   ...
   IF(NOT BZIP2_NEED_PREFIX)
    CHECK_SYMBOL_EXISTS(BZ2_bzCompressInit@16 "bzlib.h" BZIP2_NEED_PREFIX)
   ...
   cmake_pop_check_state()
    ...
    if(NOT TARGET BZip2::BZip2)
      ...
      if(BZIP2_LIBRARY)
        ...
        set_target_properties(BZip2::BZip2 PROPERTIES
          IMPORTED_LOCATION_RELEASE "${BZIP2_LIBRARY}")
        endif()
      ...
      if(NOT BZIP2_LIBRARY AND NOT BZIP2_LIBRARY_DEBUG)
        set_property(TARGET BZip2::BZip2 APPEND PROPERTY
...
if(NOT BZIP2_LIBRARY_DEBUG)
  ...
  set(BZIP2_LIBRARY_DEBUG "${BZIP2_LIBRARY}" CACHE FILEPATH "libbz2 (release)")
