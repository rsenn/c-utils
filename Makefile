...
$(BUILDDIR)xml.a: $(addprefix $(BUILDDIR),xml_attrnode.o xml_dump_attributes.o xml_dump.o xml_newnode.o xml_read_callback.o xml_read_tree.o xml_textnode.o xml_path.o xml_free.o xml_reader_init.o xml_escape.o)
	$(AR) rcs $@ $^
