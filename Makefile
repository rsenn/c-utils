...
LIBSOURCES = $(wildcard lib/*/*.c) #lib/array/array_cats.c lib/array/array_cats0.c lib/array/array_reset.c lib/array/array_equal.c lib/array/array_fail.c lib/array/array_start.c lib/array/array_get.c lib/array/array_length.c lib/array/array_truncate.c lib/array/array_trunc.c lib/array/array_bytes.c lib/array/array_cat.c lib/array/array_cate.c lib/array/array_catb.c lib/array/array_allocate.c lib/array/array_cat0.c lib/buffer/buffer_free.c lib/buffer/buffer_default.c lib/buffer/buffer_init.c lib/buffer/buffer_putnlflush.c lib/buffer/buffer_putlonglong.c lib/buffer/buffer_putnspace.c lib/buffer/buffer_fromarray.c lib/buffer/buffer_fromstr.c lib/buffer/buffer_truncfile.c lib/buffer/buffer_putc.c lib/buffer/buffer_getline_sa.c lib/buffer/buffer_putsalign.c lib/buffer/buffer_stubborn2.c lib/buffer/buffer_seek.c lib/buffer/buffer_putflush.c lib/buffer/buffer_putulonglong.c lib/buffer/buffer_0.c lib/buffer/buffer_getn.c lib/buffer/buffer_close.c lib/buffer/buffer_1.c lib/buffer/buffer_put8long.c lib/buffer/buffer_puterror2.c lib/buffer/buffer_mmapprivate.c lib/buffer/buffer_munmap.c lib/buffer/buffer_getline.c lib/buffer/buffer_putsaflush.c lib/buffer/buffer_peek.c lib/buffer/buffer_putlong.c lib/buffer/buffer_putm_internal_flush.c lib/buffer/buffer_get_token.c lib/buffer/buffer_prefetch.c lib/buffer/buffer_dummyread.c lib/buffer/buffer_tosa.c lib/buffer/buffer_getc.c lib/buffer/buffer_get_token_sa.c lib/buffer/buffer_2.c lib/buffer/buffer_frombuf.c lib/buffer/buffer_stubborn.c lib/buffer/buffer_get_token_sa_pred.c lib/buffer/buffer_init_free.c lib/buffer/buffer_putsflush.c lib/buffer/buffer_flush.c lib/buffer/buffer_mmapread_fd.c lib/buffer/buffer_putm_internal.c lib/buffer/buffer_mmapread.c lib/buffer/buffer_putalign.c lib/buffer/buffer_putulong.c lib/buffer/buffer_0small.c lib/buffer/buffer_putxlong.c lib/buffer/buffer_get_new_token_sa_pred.c lib/buffer/buffer_get_token_pred.c lib/buffer/buffer_get_new_token_sa.c lib/buffer/buffer_fromsa.c lib/buffer/buffer_putuint64.c lib/buffer/buffer_puts.c lib/buffer/buffer_puterror.c lib/buffer/buffer_get_until.c lib/buffer/buffer_skip_until.c lib/buffer/buffer_dump.c lib/buffer/buffer_dummyreadmmap.c lib/buffer/buffer_1small.c lib/buffer/buffer_putspace.c lib/buffer/buffer_get.c lib/buffer/buffer_feed.c lib/buffer/buffer_put.c lib/buffer/buffer_getnewline_sa.c lib/buffer/buffer_read_fd.c lib/buffer/buffer_putsa.c lib/byte/byte_copy.c lib/byte/byte_fill.c lib/byte/byte_copyr.c lib/byte/byte_zero.c lib/byte/byte_rchr.c lib/byte/byte_diff.c lib/byte/byte_chr.c lib/dir/dir_name.c lib/dir/dir_time.c lib/dir/dir_close.c lib/dir/dir_type.c lib/dir/dir_read.c lib/dir/dir_open.c lib/fmt/fmt_uint64.c lib/fmt/fmt_humank.c lib/fmt/fmt_asn1derlength.c lib/fmt/fmt_minus.c lib/fmt/fmt_asn1dertag.c lib/fmt/fmt_plusminus.c lib/fmt/fmt_ulonglong.c lib/fmt/fmt_long.c lib/fmt/fmt_escapecharquotedprintable.c lib/fmt/fmt_pad.c lib/fmt/fmt_escapecharc.c lib/fmt/fmt_httpdate.c lib/fmt/fmt_longlong.c lib/fmt/fmt_xlonglong.c lib/fmt/fmt_strn.c lib/fmt/fmt_str.c lib/fmt/fmt_strm_internal.c lib/fmt/fmt_escapecharxml.c lib/fmt/fmt_8long.c lib/fmt/fmt_ulong.c lib/fmt/fmt_double.c lib/fmt/fmt_tohex.c lib/fmt/fmt_ulong0.c lib/fmt/fmt_escapecharhtml.c lib/fmt/fmt_8longlong.c lib/fmt/fmt_xlong.c lib/fmt/fmt_utf8.c lib/fmt/fmt_human.c lib/fmt/fmt_xmlescape.c lib/fmt/fmt_fill.c lib/fmt/fmt_escapecharquotedprintableutf8.c lib/fmt/fmt_iso8601.c lib/hmap/hmap_add.c lib/hmap/hmap_print_tree.c lib/hmap/hmap_search.c lib/hmap/hmap_print_table.c lib/hmap/hmap_set.c lib/hmap/hmap_internal.c lib/hmap/hmap_destroy.c lib/hmap/hmap_delete.c lib/hmap/hmap_add_tuple_with_data.c lib/hmap/hmap_free_data.c lib/hmap/hmap_print_list.c lib/hmap/hmap_truncate.c lib/hmap/hmap_is_locate.c lib/hmap/hmap_init.c lib/http/http_sendreq.c lib/http/http_writeable.c lib/http/http_readable.c lib/http/http_init.c lib/http/http_get.c lib/iarray/iarray_allocate.c lib/iarray/iarray_init.c lib/iarray/iarray_get.c lib/io/io_close.c lib/io/io_waituntil.c lib/io/io_appendfile.c lib/io/io_socketpair.c lib/io/io_waitread.c lib/io/io_timeouted.c lib/io/io_mmapwritefile.c lib/io/io_timeout.c lib/io/io_block.c lib/io/io_createfile.c lib/io/io_getcookie.c lib/io/io_dontwantread.c lib/io/io_trywritetimeout.c lib/io/io_timedout.c lib/io/io_waituntil2.c lib/io/io_check.c lib/io/io_debugstring.c lib/io/io_tryreadtimeout.c lib/io/io_readfile.c lib/io/io_readwritefile.c lib/io/io_sigpipe.c lib/io/io_dontwantwrite.c lib/io/io_trywrite.c lib/io/io_nonblock.c lib/io/io_pipe.c lib/io/io_waitwrite.c lib/io/io_finishandshutdown.c lib/io/io_closeonexec.c lib/io/io_eagain_read.c lib/io/io_eagain_write.c lib/io/io_wait.c lib/io/io_wantwrite.c lib/io/io_setcookie.c lib/io/io_wantread.c lib/io/io_fd.c lib/io/io_tryread.c lib/io/io_canwrite.c lib/io/io_eagain.c lib/io/io_canread.c lib/io/io_sendfile.c lib/list/list_init.c lib/list/list_find_remove.c lib/list/list_remove.c lib/list/list_add_before.c lib/list/list_move_head.c lib/list/list_push.c lib/list/list_swap.c lib/list/list_find.c lib/list/list_move_tail.c lib/list/list_length.c lib/list/list_add_after.c lib/list/list_unshift.c lib/mmap/mmap_read_fd.c lib/mmap/mmap_unmap.c lib/mmap/mmap_private.c lib/mmap/mmap_map.c lib/mmap/mmap_read.c lib/ndelay/ndelay_off.c lib/ndelay/ndelay_on.c lib/open/open_append.c lib/open/open_trunc.c lib/open/open_rw.c lib/open/open_read.c lib/pe/pe_offsets.c lib/playlist/playlist_xspf.c lib/playlist/playlist_write_start.c lib/playlist/playlist_read.c lib/playlist/playlist_write_entry.c lib/playlist/playlist_pls.c lib/playlist/playlist_m3u.c lib/playlist/playlist_init.c lib/playlist/playlist_write_finish.c lib/rdir/rdir_close.c lib/rdir/rdir_read.c lib/rdir/rdir_open.c lib/scan/scan_ushort.c lib/scan/scan_xlonglong.c lib/scan/scan_ulong.c lib/scan/scan_fromhex.c lib/scan/scan_ulonglong.c lib/scan/scan_uint.c lib/scan/scan_ulongn.c lib/scan/scan_xlong.c lib/scan/scan_double.c lib/socket/socket_v4mappedprefix.c lib/socket/socket_connect4.c lib/socket/socket_tcp6b.c lib/socket/socket_tcp4b.c lib/socket/socket_v6loopback.c lib/socket/socket_tcp6.c lib/socket/socket_noipv6.c lib/socket/socket_connected.c lib/socket/socket_ip4loopback.c lib/socket/socket_tcp4.c lib/socket/socket_connect6.c lib/str/str_rchr.c lib/str/str_diff.c lib/str/str_tok.c lib/str/str_chr.c lib/str/str_basename.c lib/str/str_len.c lib/str/str_ptime.c lib/str/str_istr.c lib/str/str_diffn.c lib/str/str_dup.c lib/stralloc/stralloc_catlong0.c lib/stralloc/stralloc_catc.c lib/stralloc/stralloc_init.c lib/stralloc/stralloc_append.c lib/stralloc/stralloc_append_sa.c lib/stralloc/stralloc_free.c lib/stralloc/stralloc_catulong0.c lib/stralloc/stralloc_ready.c lib/stralloc/stralloc_copys.c lib/stralloc/stralloc_cats.c lib/stralloc/stralloc_nul.c lib/stralloc/stralloc_catb.c lib/stralloc/stralloc_trunc.c lib/stralloc/stralloc_zero.c lib/stralloc/stralloc_copyb.c lib/stralloc/stralloc_insertb.c lib/stralloc/stralloc_copy.c lib/stralloc/stralloc_readyplus.c lib/stralloc/stralloc_cat.c lib/stralloc/stralloc_write.c lib/stralloc/stralloc_diffs.c lib/stralloc/stralloc_move.c lib/stralloc/stralloc_remove.c lib/strarray/strarray_pushd.c lib/strarray/strarray_push.c lib/strlist/strlist_push_unique.c lib/strlist/strlist_pushsa.c lib/strlist/strlist_index_of.c lib/strlist/strlist_sort.c lib/strlist/strlist_unshift.c lib/strlist/strlist_pushm_internal.c lib/strlist/strlist_count.c lib/strlist/strlist_join.c lib/strlist/strlist_cat.c lib/strlist/strlist_push_sa.c lib/strlist/strlist_pushb.c lib/strlist/strlist_at.c lib/strlist/strlist_push.c lib/strlist/strlist_range.c lib/strlist/strlist_push_tokens.c lib/strlist/strlist_to_argv.c lib/strlist/strlist_dump.c lib/strlist/strlist_shift.c lib/tai/tai_now.c lib/tai/tai_uint.c lib/tai/tai_sub.c lib/tai/tai_unpack.c lib/tai/tai_add.c lib/tai/tai_pack.c lib/taia/taia_addsec.c lib/taia/taia_half.c lib/taia/taia_approx.c lib/taia/taia_less.c lib/taia/taia_add.c lib/taia/taia_tai.c lib/taia/taia_pack.c lib/taia/taia_sub.c lib/taia/taia_unpack.c lib/taia/taia_frac.c lib/taia/taia_uint.c lib/taia/taia_now.c lib/uint16/uint16_pack_big.c lib/uint16/uint16_pack.c lib/uint16/uint16_unpack.c lib/uint16/uint16_unpack_big.c lib/uint32/uint32_unpack_big.c lib/uint32/uint32_pack_big.c lib/uint32/uint32_unpack.c lib/uint32/uint32_pack.c lib/uint64/uint64_pack_big.c lib/uint64/uint64_unpack.c lib/uint64/uint64_pack.c lib/uint64/uint64_unpack_big.c
