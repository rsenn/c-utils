...
$(BUILDDIR)mediathek-parser$(M64_)$(EXESUFFIX)$(EXEEXT): $(BUILDDIR)mediathek-parser.o $(BUILDDIR)buffer_1.o $(BUILDDIR)buffer_get_token_pred.o $(BUILDDIR)buffer_init.o $(BUILDDIR)buffer_putnlflush.o $(BUILDDIR)buffer_puts.o $(BUILDDIR)buffer_putsa.o $(BUILDDIR)open_read.o $(BUILDDIR)stralloc_copyb.o $(BUILDDIR)stralloc_init.o $(BUILDDIR)buffer_getc.o $(BUILDDIR)buffer_put.o $(BUILDDIR)buffer_putflush.o $(BUILDDIR)byte_copy.o $(BUILDDIR)stralloc_ready.o $(BUILDDIR)str_len.o $(BUILDDIR)buffer_feed.o $(BUILDDIR)buffer_flush.o $(BUILDDIR)buffer_stubborn.o $(BUILDDIR)buffer_stubborn2.o $(BUILDDIR)buffer_putsflush.o $(BUILDDIR)buffer_putulong.o $(BUILDDIR)fmt_ulong.o $(BUILDDIR)byte_chr.o $(BUILDDIR)buffer_2.o $(BUILDDIR)buffer_get.o $(BUILDDIR)buffer_peek.o $(BUILDDIR)buffer_get_token.o $(BUILDDIR)buffer_getline.o $(BUILDDIR)buffer_get_token_sa.o $(BUILDDIR)stralloc_zero.o  $(BUILDDIR)stralloc_append.o $(BUILDDIR)stralloc_readyplus.o $(BUILDDIR)buffer_close.o $(BUILDDIR)buffer_mmapread.o $(BUILDDIR)mmap_read.o $(BUILDDIR)buffer_munmap.o $(BUILDDIR)buffer_dump.o $(BUILDDIR)buffer_dummyreadmmap.o $(BUILDDIR)buffer_putc.o $(BUILDDIR)buffer_putnspace.o $(BUILDDIR)buffer_putspace.o $(BUILDDIR)fmt_long.o $(BUILDDIR)fmt_xlong.o $(BUILDDIR)stralloc_write.o $(BUILDDIR)byte_fill.o  $(BUILDDIR)buffer_putxlong.o $(BUILDDIR)strlist_pushsa.o $(BUILDDIR)strlist_count.o $(BUILDDIR)strlist_dump.o $(BUILDDIR)strlist_at.o $(BUILDDIR)strlist_pushb.o $(BUILDDIR)strlist_pushsa.o $(BUILDDIR)stralloc_free.o $(BUILDDIR)stralloc_catb.o $(BUILDDIR)stralloc_catc.o $(BUILDDIR)array_allocate.o $(BUILDDIR)array_start.o	$(BUILDDIR)byte_zero.o $(BUILDDIR)umult64.o
	$(CROSS_COMPILE)$(CC) $(LDFLAGS) $(CFLAGS) -o $@ $^ $(LIBS)  
