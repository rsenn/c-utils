...
$(BUILDDIR)mediathek-parser$(M64_)$(EXESUFFIX)$(EXEEXT): $(BUILDDIR)mediathek-parser.o $(BUILDDIR)buffer_1.o $(BUILDDIR)buffer_get_token_pred.o $(BUILDDIR)buffer_init.o $(BUILDDIR)buffer_putnlflush.o $(BUILDDIR)buffer_puts.o $(BUILDDIR)buffer_putsa.o $(BUILDDIR)open_read.o $(BUILDDIR)stralloc_copyb.o $(BUILDDIR)stralloc_init.o $(BUILDDIR)buffer_getc.o $(BUILDDIR)buffer_put.o $(BUILDDIR)buffer_putflush.o $(BUILDDIR)byte_copy.o $(BUILDDIR)stralloc_ready.o $(BUILDDIR)str_len.o $(BUILDDIR)buffer_feed.o $(BUILDDIR)buffer_flush.o $(BUILDDIR)buffer_stubborn.o $(BUILDDIR)buffer_stubborn2.o $(BUILDDIR)buffer_putsflush.o $(BUILDDIR)buffer_putulong.o $(BUILDDIR)fmt_ulong.o $(BUILDDIR)byte_chr.o $(BUILDDIR)buffer_2.o $(BUILDDIR)buffer_get.o $(BUILDDIR)buffer_peek.o
	$(CROSS_COMPILE)$(CC) $(LDFLAGS) $(CFLAGS) -o $@ $^ $(LIBS)  
