...
file(WRITE "${CMAKE_BINARY_DIR}/try_dynstack.c" "void test_dynstack(size_t n) {\n  char x[n+1];\n  x[n] = 0;\n}\nint main(int argc, char* argv[]) {\n  test_dynstack(argc);\n}")
try_compile(HAVE_DYNSTACK "${CMAKE_BINARY_DIR}" SOURCES "${CMAKE_BINARY_DIR}/try_dynstack.c")
