if(BUILD_SSL)
  ...
  if(NOT EXISTS "${CMAKE_SOURCE_DIR}/3rdparty/openssl/CMakeLists.txt")
    ...
    exec_program(
      "${TAR}" ARGS
      -C "${CMAKE_SOURCE_DIR}/3rdparty" -xzf
      "${CMAKE_SOURCE_DIR}/3rdparty/openssl-${OPENSSL_VERSION}.tar.gz")
    file(
    ...
    execute_process(
      COMMAND patch -p0
      INPUT_FILE "${CMAKE_SOURCE_DIR}/3rdparty/openssl-1.1.1l-ecerr.patch"
    ...
    file(RENAME "${CMAKE_SOURCE_DIR}/3rdparty/openssl-${OPENSSL_VERSION}"
  ...
  set(OPENSSL_INCLUDE_DIR "${CMAKE_SOURCE_DIR}/3rdparty/openssl/include"
      CACHE FILEPATH "")
