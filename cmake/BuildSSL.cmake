if(BUILD_SSL)
  ...
  if(NOT EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/3rdparty/openssl/CMakeLists.txt")
    if(NOT EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/openssl-${OPENSSL_VERSION}.tar.gz")
      ...
      file(DOWNLOAD "https://www.openssl.org/source/openssl-${OPENSSL_VERSION}.tar.gz"
           "${CMAKE_CURRENT_SOURCE_DIR}/3rdparty/openssl-${OPENSSL_VERSION}.tar.gz" SHOW_PROGRESS)
    endif()

    exec_program(
      "${TAR}" ARGS -C "${CMAKE_CURRENT_SOURCE_DIR}/3rdparty" -xzf
                    "${CMAKE_CURRENT_SOURCE_DIR}/3rdparty/openssl-${OPENSSL_VERSION}.tar.gz")
    ...
    execute_process(
      COMMAND patch -p0
      INPUT_FILE "${CMAKE_CURRENT_SOURCE_DIR}/3rdparty/openssl-1.1.1h-getrandom.patch"
      WORKING_DIRECTORY "${CMAKE_CURRENT_SOURCE_DIR}")

    file(RENAME "${CMAKE_CURRENT_SOURCE_DIR}/3rdparty/openssl-${OPENSSL_VERSION}"
         "${CMAKE_CURRENT_SOURCE_DIR}/3rdparty/openssl")
    # exec_program("${TAR}" ARGS -C "${CMAKE_CURRENT_SOURCE_DIR}/3rdparty/openssl" -xvzf
    # "${CMAKE_CURRENT_SOURCE_DIR}/3rdparty/openssl-cmake.tar.gz")
  ...
  # if(NOT OPENSSL_LIBRARIES) message(WARNING "Variable OPENSSL_LIBRARIES not set!") endif(NOT
  # OPENSSL_LIBRARIES)
