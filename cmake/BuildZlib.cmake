if(BUILD_ZLIB)
  ...
  if(NOT EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/3rdparty/zlib/adler32.c")
    if(NOT EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/zlib-${ZLIB_VERSION}.tar.gz")
      ...
      file(DOWNLOAD "https://zlib.net/zlib-${ZLIB_VERSION}.tar.gz" "${CMAKE_CURRENT_SOURCE_DIR}/3rdparty/zlib-${ZLIB_VERSION}.tar.gz" SHOW_PROGRESS)
    endif()
  ...
  set_target_properties(z PROPERTIES ARCHIVE_OUTPUT_DIRECTORY "${CMAKE_CURRENT_BINARY_DIR}/zlib" LIBRARY_OUTPUT_DIRECTORY "${CMAKE_CURRENT_BINARY_DIR}/zlib")
