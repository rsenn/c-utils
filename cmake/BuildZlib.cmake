if(BUILD_ZLIB)
  ...
  set(ZLIB_SOURCES
      3rdparty/zlib/adler32.c 3rdparty/zlib/compress.c 3rdparty/zlib/crc32.c 3rdparty/zlib/deflate.c
      3rdparty/zlib/infback.c 3rdparty/zlib/inffast.c 3rdparty/zlib/inflate.c 3rdparty/zlib/inftrees.c
      3rdparty/zlib/trees.c 3rdparty/zlib/uncompr.c 3rdparty/zlib/zutil.c)
  add_library(z ${ZLIB_SOURCES})
  set_target_properties(z PROPERTIES ARCHIVE_OUTPUT_DIRECTORY "${CMAKE_CURRENT_BINARY_DIR}/zlib"
  ...
  set(ZLIB_LIBRARY_DIR "${CMAKE_BINARY_DIR}/zlib" CACHE PATH "zlib library dir" FORCE)
  set(ZLIB_INCLUDE_DIR "${CMAKE_SOURCE_DIR}/3rdparty/zlib" CACHE PATH "zlib include dir" FORCE)
endif(BUILD_ZLIB)
