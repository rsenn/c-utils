if(USE_LZMA)
  ...
  # Check LibLZMA
  # ################################################################################################
  # pkg_search_module(LIBLZMA liblzma lzma) if(LIBLZMA_FOUND) if(pkgcfg_lib_LIBLZMA_lzma)
  # set(LIBLZMA_LIBRARY ${pkgcfg_lib_LIBLZMA_lzma} CACHE FILEPATH "") endif(pkgcfg_lib_LIBLZMA_lzma)
  # endif(LIBLZMA_FOUND)
  #
