macro(check_msys_cygwin_mingw)
  ...
  try_compile(TRY_MSYS "${CMAKE_BINARY_DIR}/cmake" ${CMAKE_BINARY_DIR}/cmake/try-msys.c COMPILE_DEFINITIONS "-Wl,-municode;-DUNICODE;-D_UNICODE;" OUTPUT_VARIABLE OUTPUT)
  message("OUTPUT: ${OUTPUT}")
  if(TRY_MSYS)
    set(MSYS TRUE CACHE BOOL "System is Msys")
    set(SYS msys)
  else(TRY_MSYS)
    try_compile(TRY_CYGWIN "${CMAKE_BINARY_DIR}/cmake" ${CMAKE_BINARY_DIR}/cmake/try-cygwin.c OUTPUT_VARIABLE OUTPUT)
    if(TRY_CYGWIN)
      set(CYGWIN TRUE CACHE BOOL "System is Cygwin")
      set(SYS cygwin)
    else(TRY_CYGWIN)
      try_compile(TRY_MINGW "${CMAKE_BINARY_DIR}/cmake" ${CMAKE_BINARY_DIR}/cmake/try-mingw.c OUTPUT_VARIABLE OUTPUT)
      if(TRY_MINGW)
