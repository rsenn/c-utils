...
try_compile(HAVE_ALLOCA ${CMAKE_CURRENT_BINARY_DIR}
            SOURCES "${CMAKE_CURRENT_BINARY_DIR}/tryalloca.c")
if(HAVE_ALLOCA)
...
try_compile(HAVE_BSDSF ${CMAKE_CURRENT_BINARY_DIR}
            SOURCES "${CMAKE_CURRENT_BINARY_DIR}/trybsdsf.c")
if(HAVE_BSDSF)
  file(WRITE "${CMAKE_CURRENT_BINARY_DIR}/havebsdsf.h"
       "#define HAVE_BSDSENDFILE\n")
endif(HAVE_BSDSF)
...
try_compile(HAVE_DEVPOLL ${CMAKE_CURRENT_BINARY_DIR}
            SOURCES "${CMAKE_CURRENT_BINARY_DIR}/trydevpoll.c")
if(HAVE_DEVPOLL)
  file(WRITE "${CMAKE_CURRENT_BINARY_DIR}/havedevpoll.h"
       "#define HAVE_DEVPOLL\n")
endif(HAVE_DEVPOLL)
...
try_compile(HAVE_EPOLL ${CMAKE_CURRENT_BINARY_DIR}
            SOURCES "${CMAKE_CURRENT_BINARY_DIR}/tryepoll.c")
if(HAVE_EPOLL)
...
file(WRITE "${CMAKE_CURRENT_BINARY_DIR}/tryinline.c"
     "static inline int foo(int bar) { return bar+1; }")
try_compile(HAVE_INLINE ${CMAKE_CURRENT_BINARY_DIR}
            SOURCES "${CMAKE_CURRENT_BINARY_DIR}/tryinline.c")
if(NOT HAVE_INLINE)
...
try_compile(HAVE_IP6 ${CMAKE_CURRENT_BINARY_DIR}
            SOURCES "${CMAKE_CURRENT_BINARY_DIR}/tryip6.c")
if(HAVE_IP6)
...
try_compile(HAVE_KQUEUE ${CMAKE_CURRENT_BINARY_DIR}
            SOURCES "${CMAKE_CURRENT_BINARY_DIR}/trykqueue.c")
if(HAVE_KQUEUE)
...
try_compile(HAVE_N2I ${CMAKE_CURRENT_BINARY_DIR}
            SOURCES "${CMAKE_CURRENT_BINARY_DIR}/tryn2i.c")
if(HAVE_N2I)
...
try_compile(HAVE_POLL ${CMAKE_CURRENT_BINARY_DIR}
            SOURCES "${CMAKE_CURRENT_BINARY_DIR}/trypoll.c")
if(HAVE_POLL)
  file(
...
try_compile(HAVE_PREAD ${CMAKE_CURRENT_BINARY_DIR}
            SOURCES "${CMAKE_CURRENT_BINARY_DIR}/trypread.c")
if(HAVE_PREAD)
...
try_compile(HAVE_SCOPE ${CMAKE_CURRENT_BINARY_DIR}
            SOURCES "${CMAKE_CURRENT_BINARY_DIR}/tryscope.c")
if(HAVE_SCOPE)
  file(WRITE "${CMAKE_CURRENT_BINARY_DIR}/havescope.h"
...
try_compile(HAVE_SENDFILE ${CMAKE_CURRENT_BINARY_DIR}
            SOURCES "${CMAKE_CURRENT_BINARY_DIR}/trysendfile.c")
if(HAVE_SENDFILE)
  file(WRITE "${CMAKE_CURRENT_BINARY_DIR}/havesendfile.h"
...
try_compile(HAVE_SIGIO ${CMAKE_CURRENT_BINARY_DIR}
            SOURCES "${CMAKE_CURRENT_BINARY_DIR}/trysigio.c")
if(HAVE_SIGIO)
...
try_compile(HAVE_SL ${CMAKE_CURRENT_BINARY_DIR}
            SOURCES "${CMAKE_CURRENT_BINARY_DIR}/trysl.c")
if(NOT HAVE_SL)
...
try_compile(HAVE_LIBSOCKET ${CMAKE_CURRENT_BINARY_DIR}
            SOURCES "${CMAKE_CURRENT_BINARY_DIR}/trysocket.c")
if(HAVE_LIBSOCKET)
...
try_compile(HAVE_SELECT ${CMAKE_CURRENT_BINARY_DIR}
            SOURCES "${CMAKE_CURRENT_BINARY_DIR}/trysysel.c")
if(HAVE_SELECT)
  file(
...
try_compile(HAVE_UINT128 ${CMAKE_CURRENT_BINARY_DIR}
            SOURCES "${CMAKE_CURRENT_BINARY_DIR}/tryuint128.c")
if(HAVE_UINT128)
  file(WRITE "${CMAKE_CURRENT_BINARY_DIR}/haveuint128.h"
       "#define HAVE_UINT128\n")
endif(HAVE_UINT128)
