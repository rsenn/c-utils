...
static uogetopt2 myopts[] = {
    ...
    {0,
     ...
     "  ftpls \\\n"
     "  --html --title 'CVS tree index      y date' \\\n"
     "  --urlprefix      tp://ftp.ohse.de/uwe/cvs-trees/      \\\n"
     "  --newest \\\n"
     "       tp://serak.ohse.de/uwe/     vs-trees \\\n"
     "  >      OMEWHERE/cvs-trees/     ndex-by-date.html\n",
     0},
    ...
    {0,
     ...
     "ftpcopy(1) creates and maintains      tp      irrors.\n" COMMON_RELATED_INFO,
     0},
