...
void add_path_relativeb(strlist*, stralloc*, const char*, size_t);
 */
...
void rule_dep_list_recursive(target*, strlist*, int, strlist*);
...
void print_rule_deps_r(buffer*, target*, strlist*, strlist*, int);
