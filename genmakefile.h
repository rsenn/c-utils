...
void gen_clean_rule(HMAP_DB*);
target* gen_install_rules(HMAP_DB*);
void gen_lib_rules(HMAP_DB*, HMAP_DB* srcdirs);
int gen_link_rules(HMAP_DB*, strarray* sources);
target* gen_simple_compile_rules(
    HMAP_DB*, sourcedir* srcdir, const char* dir, const char* fromext, const char* toext, stralloc* cmd);
target* gen_single_rule(HMAP_DB*, stralloc* output, strlist* prereq, stralloc* cmd);
target* gen_srcdir_compile_rules(HMAP_DB*, sourcedir* sdir, const char* dir);
void gen_srcdir_rule(HMAP_DB*, sourcedir* sdir, const char* name);
...
target* lib_rule_for_sourcedir(HMAP_DB*, sourcedir* srcdir, const char* name);
...
void output_all_rules(buffer*, HMAP_DB* hmap);
...
void sourcedir_populate(HMAP_DB*, strarray* sources);
...
void var_output(buffer*, HMAP_DB* vars, const char* name);
