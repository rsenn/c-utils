...
void sourcedir_dump_all(buffer*, HMAP_DB* sourcedirs);
...
void sourcedir_gen_rule(HMAP_DB*, sourcedir* sdir, const char* name);
...
target* gen_srcdir_lib_rule(HMAP_DB*, sourcedir* srcdir, const char* name);
