...
static inline int
compare_and_swap(volatile size_t* x, size_t oldval, size_t newval) {
#ifdef USE_BUILTINS
...
atomic_add_return(size_t* x, size_t val) {
#ifdef USE_BUILTINS
...
/* *x += val; */
static inline void
atomic_add(size_t* x, size_t val) {
#ifdef USE_BUILTINS
...
static inline size_t
atomic_dec_return(size_t* x) {
  return atomic_add_return(x, -1);
}

/* *x |= val; */
static inline void
atomic_or(volatile size_t* x, size_t val) {
#ifdef USE_BUILTINS
...
/* *x &= val; */
static inline void
atomic_and(volatile size_t* x, size_t val) {
#ifdef USE_BUILTINS
