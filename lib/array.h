...
/* inline static void
array_sort(array* x, uint64 membersize, int (*compare_fn)(const void*,const void*)) {
...
int64
array_splice(array*, uint64 membersize, uint64 start, uint64 del, uint64 insert, const void* x);
