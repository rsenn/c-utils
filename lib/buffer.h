...
ssize_t
buffer_get_token_pred(buffer*, char* x, size_t len, string_predicate p, void*);
...
int
buffer_get_token_sa(buffer*, stralloc* sa, const char* charset, size_t setlen);
