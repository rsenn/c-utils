...
#define buffer_puts(b, s)                                                                          \
  (__builtin_constant_p(s) ? buffer_put(b, s, __builtin_strlen(s)) : buffer_puts(b, s))
...
int buffer_put_escaped(buffer*, const char* x, size_t len, size_t (*)(char*, int, int));
int buffer_puts_escaped(buffer*, const char* x, size_t (*)(char*, int, int));
