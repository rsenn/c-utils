...
/**
 ...
 Keys and values may be changed during the map lifetime, because copies are not modified.
*/
cbmap_t
cbmap_new(void);
...
int cbmap_visit(uint8_t *top, cbmap_visitor visitor_fn, void *user_data);
