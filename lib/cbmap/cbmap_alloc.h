...
/*
   Set 'ALLOC_DEBUG' to 1 to enable poor man's memory debugging (not thread
   safe).
*/
...
#define CBM_CALLOC(n, s) \
  cbmap_mem_debug_calloc((n), (s), __FILE__, __LINE__)
...
#define CBM_STRNDUP(s, n) \
  cbmap_mem_debug_strndup((s), (n), __FILE__, __LINE__)
