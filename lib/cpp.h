...
void cpp_error_or_warning(const char*,
                          const char* type,
                          tokenizer* t,
                          token* curr);
int
cpp_evaluate_condition(cpp*, tokenizer* t, int* result, char* visited[]);
void cpp_free(cpp*);
...
unsigned cpp_macro_get_info(cpp*,
                            tokenizer* t,
                            cpp_macro_info* mi_list,
                            size_t* mi_cnt,
                            unsigned nest,
                            unsigned tpos,
                            const char* name,
...
int cpp_parse_expect(tokenizer*,
                     enum tokentype tt,
