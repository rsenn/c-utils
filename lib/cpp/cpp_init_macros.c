...
define_clang_macros(void) {
  ...
  cpp_macro_define("__BITINT_MAXWIDTH__", "8388608");
  cpp_macro_define("__BOOL_WIDTH__", "8");
  cpp_macro_define("__BYTE_ORDER__", "__ORDER_LITTLE_ENDIAN__");
  cpp_macro_define("__CHAR16_TYPE__", "unsigned short");
  cpp_macro_define("__CHAR32_TYPE__", "unsigned int");
  cpp_macro_define("__CHAR_BIT__", "8");
  cpp_macro_define("__clang__", "1");
  cpp_macro_define("__CLANG_ATOMIC_BOOL_LOCK_FREE", "2");
  cpp_macro_define("__CLANG_ATOMIC_CHAR16_T_LOCK_FREE", "2");
  cpp_macro_define("__CLANG_ATOMIC_CHAR32_T_LOCK_FREE", "2");
  cpp_macro_define("__CLANG_ATOMIC_CHAR_LOCK_FREE", "2");
  cpp_macro_define("__CLANG_ATOMIC_INT_LOCK_FREE", "2");
  cpp_macro_define("__CLANG_ATOMIC_LLONG_LOCK_FREE", "2");
  cpp_macro_define("__CLANG_ATOMIC_LONG_LOCK_FREE", "2");
  cpp_macro_define("__CLANG_ATOMIC_POINTER_LOCK_FREE", "2");
  cpp_macro_define("__CLANG_ATOMIC_SHORT_LOCK_FREE", "2");
  cpp_macro_define("__CLANG_ATOMIC_WCHAR_T_LOCK_FREE", "2");
  cpp_macro_define("__clang_literal_encoding__", "\"UTF-8\"");
  cpp_macro_define("__clang_major__", "19");
  cpp_macro_define("__clang_minor__", "1");
  cpp_macro_define("__clang_patchlevel__", "7");
  cpp_macro_define("__clang_version__", "\"19.1.7 (++20250114103238+cd708029e0b2-1~exp1~20250114103342.77)\"");
  cpp_macro_define("__clang_wide_literal_encoding__", "\"UTF-32\"");
  cpp_macro_define("__code_model_small__", "1");
  cpp_macro_define("__CONSTANT_CFSTRINGS__", "1");
  cpp_macro_define("__DBL_DECIMAL_DIG__", "17");
  cpp_macro_define("__DBL_DENORM_MIN__", "4.9406564584124654e-324");
  cpp_macro_define("__DBL_DIG__", "15");
  cpp_macro_define("__DBL_EPSILON__", "2.2204460492503131e-16");
  ...
  cpp_macro_define("__DBL_MAX__", "1.7976931348623157e+308");
  cpp_macro_define("__DBL_MAX_EXP__", "1024");
  cpp_macro_define("__DBL_MIN_10_EXP__", "(-307)");
  cpp_macro_define("__DBL_MIN__", "2.2250738585072014e-308");
  cpp_macro_define("__DBL_MIN_EXP__", "(-1021)");
  cpp_macro_define("__DBL_NORM_MAX__", "1.7976931348623157e+308");
  cpp_macro_define("__DECIMAL_DIG__", "__LDBL_DECIMAL_DIG__");
  cpp_macro_define("__ELF__", "1");
  cpp_macro_define("__FINITE_MATH_ONLY__", "0");
  cpp_macro_define("__FLOAT128__", "1");
  cpp_macro_define("__FLT16_DECIMAL_DIG__", "5");
  cpp_macro_define("__FLT16_DENORM_MIN__", "5.9604644775390625e-8F16");
  cpp_macro_define("__FLT16_DIG__", "3");
  cpp_macro_define("__FLT16_EPSILON__", "9.765625e-4F16");
  ...
  cpp_macro_define("__FLT16_MAX__", "6.5504e+4F16");
  cpp_macro_define("__FLT16_MAX_EXP__", "16");
  cpp_macro_define("__FLT16_MIN_10_EXP__", "(-4)");
  cpp_macro_define("__FLT16_MIN__", "6.103515625e-5F16");
  cpp_macro_define("__FLT16_MIN_EXP__", "(-13)");
  cpp_macro_define("__FLT16_NORM_MAX__", "6.5504e+4F16");
  cpp_macro_define("__FLT_DECIMAL_DIG__", "9");
  cpp_macro_define("__FLT_DENORM_MIN__", "1.40129846e-45F");
  cpp_macro_define("__FLT_DIG__", "6");
  cpp_macro_define("__FLT_EPSILON__", "1.19209290e-7F");
  ...
  cpp_macro_define("__FLT_MAX__", "3.40282347e+38F");
  cpp_macro_define("__FLT_MAX_EXP__", "128");
  cpp_macro_define("__FLT_MIN_10_EXP__", "(-37)");
  cpp_macro_define("__FLT_MIN__", "1.17549435e-38F");
  cpp_macro_define("__FLT_MIN_EXP__", "(-125)");
  cpp_macro_define("__FLT_NORM_MAX__", "3.40282347e+38F");
  cpp_macro_define("__FLT_RADIX__", "2");
  cpp_macro_define("__FPCLASS_NEGINF", "0x0004");
  cpp_macro_define("__FPCLASS_NEGNORMAL", "0x0008");
  cpp_macro_define("__FPCLASS_NEGSUBNORMAL", "0x0010");
  cpp_macro_define("__FPCLASS_NEGZERO", "0x0020");
  cpp_macro_define("__FPCLASS_POSINF", "0x0200");
  cpp_macro_define("__FPCLASS_POSNORMAL", "0x0100");
  cpp_macro_define("__FPCLASS_POSSUBNORMAL", "0x0080");
  cpp_macro_define("__FPCLASS_POSZERO", "0x0040");
  cpp_macro_define("__FPCLASS_QNAN", "0x0002");
  cpp_macro_define("__FPCLASS_SNAN", "0x0001");
  ...
  cpp_macro_define("__GNUC__", "4");
  cpp_macro_define("__GNUC_MINOR__", "2");
  cpp_macro_define("__GNUC_PATCHLEVEL__", "1");
  cpp_macro_define("__GNUC_STDC_INLINE__", "1");
  cpp_macro_define("__gnu_linux__", "1");
  cpp_macro_define("__GXX_ABI_VERSION", "1002");
  cpp_macro_define("__INT16_C_SUFFIX__", "");
  cpp_macro_define("__INT16_FMTd__", "\"hd\"");
  cpp_macro_define("__INT16_FMTi__", "\"hi\"");
  cpp_macro_define("__INT16_MAX__", "32767");
  cpp_macro_define("__INT16_TYPE__", "short");
  cpp_macro_define("__INT32_C_SUFFIX__", "");
  cpp_macro_define("__INT32_FMTd__", "\"d\"");
  cpp_macro_define("__INT32_FMTi__", "\"i\"");
  cpp_macro_define("__INT32_MAX__", "2147483647");
  cpp_macro_define("__INT32_TYPE__", "int");
  cpp_macro_define("__INT64_C_SUFFIX__", "L");
  cpp_macro_define("__INT64_FMTd__", "\"ld\"");
  cpp_macro_define("__INT64_FMTi__", "\"li\"");
  cpp_macro_define("__INT64_MAX__", "9223372036854775807L");
  cpp_macro_define("__INT64_TYPE__", "long int");
  cpp_macro_define("__INT8_C_SUFFIX__", "");
  cpp_macro_define("__INT8_FMTd__", "\"hhd\"");
  cpp_macro_define("__INT8_FMTi__", "\"hhi\"");
  cpp_macro_define("__INT8_MAX__", "127");
  cpp_macro_define("__INT8_TYPE__", "signed char");
  cpp_macro_define("__INT_FAST16_FMTd__", "\"hd\"");
  cpp_macro_define("__INT_FAST16_FMTi__", "\"hi\"");
  cpp_macro_define("__INT_FAST16_MAX__", "32767");
  cpp_macro_define("__INT_FAST16_TYPE__", "short");
  cpp_macro_define("__INT_FAST16_WIDTH__", "16");
  cpp_macro_define("__INT_FAST32_FMTd__", "\"d\"");
  cpp_macro_define("__INT_FAST32_FMTi__", "\"i\"");
  cpp_macro_define("__INT_FAST32_MAX__", "2147483647");
  cpp_macro_define("__INT_FAST32_TYPE__", "int");
  cpp_macro_define("__INT_FAST32_WIDTH__", "32");
  cpp_macro_define("__INT_FAST64_FMTd__", "\"ld\"");
  cpp_macro_define("__INT_FAST64_FMTi__", "\"li\"");
  cpp_macro_define("__INT_FAST64_MAX__", "9223372036854775807L");
  cpp_macro_define("__INT_FAST64_TYPE__", "long int");
  cpp_macro_define("__INT_FAST64_WIDTH__", "64");
  cpp_macro_define("__INT_FAST8_FMTd__", "\"hhd\"");
  cpp_macro_define("__INT_FAST8_FMTi__", "\"hhi\"");
  cpp_macro_define("__INT_FAST8_MAX__", "127");
  cpp_macro_define("__INT_FAST8_TYPE__", "signed char");
  cpp_macro_define("__INT_FAST8_WIDTH__", "8");
  cpp_macro_define("__INT_LEAST16_FMTd__", "\"hd\"");
  cpp_macro_define("__INT_LEAST16_FMTi__", "\"hi\"");
  cpp_macro_define("__INT_LEAST16_MAX__", "32767");
  cpp_macro_define("__INT_LEAST16_TYPE__", "short");
  cpp_macro_define("__INT_LEAST16_WIDTH__", "16");
  cpp_macro_define("__INT_LEAST32_FMTd__", "\"d\"");
  cpp_macro_define("__INT_LEAST32_FMTi__", "\"i\"");
  cpp_macro_define("__INT_LEAST32_MAX__", "2147483647");
  cpp_macro_define("__INT_LEAST32_TYPE__", "int");
  cpp_macro_define("__INT_LEAST32_WIDTH__", "32");
  cpp_macro_define("__INT_LEAST64_FMTd__", "\"ld\"");
  cpp_macro_define("__INT_LEAST64_FMTi__", "\"li\"");
  cpp_macro_define("__INT_LEAST64_MAX__", "9223372036854775807L");
  cpp_macro_define("__INT_LEAST64_TYPE__", "long int");
  cpp_macro_define("__INT_LEAST64_WIDTH__", "64");
  cpp_macro_define("__INT_LEAST8_FMTd__", "\"hhd\"");
  cpp_macro_define("__INT_LEAST8_FMTi__", "\"hhi\"");
  cpp_macro_define("__INT_LEAST8_MAX__", "127");
  cpp_macro_define("__INT_LEAST8_TYPE__", "signed char");
  cpp_macro_define("__INT_LEAST8_WIDTH__", "8");
  cpp_macro_define("__INT_MAX__", "2147483647");
  cpp_macro_define("__INTMAX_C_SUFFIX__", "L");
  cpp_macro_define("__INTMAX_FMTd__", "\"ld\"");
  cpp_macro_define("__INTMAX_FMTi__", "\"li\"");
  cpp_macro_define("__INTMAX_MAX__", "9223372036854775807L");
  cpp_macro_define("__INTMAX_TYPE__", "long int");
  cpp_macro_define("__INTMAX_WIDTH__", "64");
  cpp_macro_define("__INTPTR_FMTd__", "\"ld\"");
  cpp_macro_define("__INTPTR_FMTi__", "\"li\"");
  cpp_macro_define("__INTPTR_MAX__", "9223372036854775807L");
  ...
  cpp_macro_define("__LDBL_DENORM_MIN__", "3.64519953188247460253e-4951L");
  cpp_macro_define("__LDBL_DIG__", "18");
  cpp_macro_define("__LDBL_EPSILON__", "1.08420217248550443401e-19L");
  ...
  cpp_macro_define("__LDBL_MAX__", "1.18973149535723176502e+4932L");
  cpp_macro_define("__LDBL_MAX_EXP__", "16384");
  cpp_macro_define("__LDBL_MIN_10_EXP__", "(-4931)");
  cpp_macro_define("__LDBL_MIN__", "3.36210314311209350626e-4932L");
  cpp_macro_define("__LDBL_MIN_EXP__", "(-16381)");
  cpp_macro_define("__LDBL_NORM_MAX__", "1.18973149535723176502e+4932L");
  cpp_macro_define("__linux", "1");
  cpp_macro_define("__linux__", "1");
  cpp_macro_define("linux", "1");
  cpp_macro_define("__LITTLE_ENDIAN__", "1");
  cpp_macro_define("__LLONG_WIDTH__", "64");
  cpp_macro_define("__llvm__", "1");
  cpp_macro_define("__LONG_LONG_MAX__", "9223372036854775807LL");
  cpp_macro_define("__LONG_MAX__", "9223372036854775807L");
  cpp_macro_define("__LONG_WIDTH__", "64");
  cpp_macro_define("__LP64__", "1");
  cpp_macro_define("_LP64", "1");
  cpp_macro_define("__MEMORY_SCOPE_DEVICE", "1");
  cpp_macro_define("__MEMORY_SCOPE_SINGLE", "4");
  cpp_macro_define("__MEMORY_SCOPE_SYSTEM", "0");
  cpp_macro_define("__MEMORY_SCOPE_WRKGRP", "2");
  cpp_macro_define("__MEMORY_SCOPE_WVFRNT", "3");
  cpp_macro_define("__MMX__", "1");
  cpp_macro_define("__NO_INLINE__", "1");
  cpp_macro_define("__NO_MATH_INLINES", "1");
  cpp_macro_define("__OBJC_BOOL_IS_BOOL", "0");
  cpp_macro_define("__OPENCL_MEMORY_SCOPE_ALL_SVM_DEVICES", "3");
  cpp_macro_define("__OPENCL_MEMORY_SCOPE_DEVICE", "2");
  cpp_macro_define("__OPENCL_MEMORY_SCOPE_SUB_GROUP", "4");
  cpp_macro_define("__OPENCL_MEMORY_SCOPE_WORK_GROUP", "1");
  cpp_macro_define("__OPENCL_MEMORY_SCOPE_WORK_ITEM", "0");
  ...
  cpp_macro_define("__PIE__", "2");
  cpp_macro_define("__POINTER_WIDTH__", "64");
  cpp_macro_define("__PRAGMA_REDEFINE_EXTNAME", "1");
  cpp_macro_define("__PTRDIFF_FMTd__", "\"ld\"");
  cpp_macro_define("__PTRDIFF_FMTi__", "\"li\"");
  cpp_macro_define("__PTRDIFF_MAX__", "9223372036854775807L");
  cpp_macro_define("__PTRDIFF_TYPE__", "long int");
  cpp_macro_define("__PTRDIFF_WIDTH__", "64");
  cpp_macro_define("__REGISTER_PREFIX__", "");
  cpp_macro_define("__SCHAR_MAX__", "127");
  cpp_macro_define("__SEG_FS", "1");
  cpp_macro_define("__seg_fs", "__attribute__((address_space(257)))");
  cpp_macro_define("__SEG_GS", "1");
  cpp_macro_define("__seg_gs", "__attribute__((address_space(256)))");
  cpp_macro_define("__SHRT_MAX__", "32767");
  cpp_macro_define("__SHRT_WIDTH__", "16");
  cpp_macro_define("__SIG_ATOMIC_MAX__", "2147483647");
  cpp_macro_define("__SIG_ATOMIC_WIDTH__", "32");
  cpp_macro_define("__SIZE_FMTo__", "\"lo\"");
  cpp_macro_define("__SIZE_FMTu__", "\"lu\"");
  cpp_macro_define("__SIZE_FMTx__", "\"lx\"");
  cpp_macro_define("__SIZE_FMTX__", "\"lX\"");
  cpp_macro_define("__SIZE_MAX__", "18446744073709551615UL");
  cpp_macro_define("__SIZEOF_DOUBLE__", "8");
  ...
  cpp_macro_define("__STDC__", "1");
  cpp_macro_define("__STDC_EMBED_EMPTY__", "2");
  cpp_macro_define("__STDC_EMBED_FOUND__", "1");
  cpp_macro_define("__STDC_EMBED_NOT_FOUND__", "0");
  cpp_macro_define("__STDC_HOSTED__", "1");
  cpp_macro_define("__STDC_UTF_16__", "1");
  cpp_macro_define("__STDC_UTF_32__", "1");
  cpp_macro_define("__STDC_VERSION__", "201710L");
  cpp_macro_define("__tune_k8__", "1");
  cpp_macro_define("__UINT16_C_SUFFIX__", "");
  cpp_macro_define("__UINT16_FMTo__", "\"ho\"");
  cpp_macro_define("__UINT16_FMTu__", "\"hu\"");
  cpp_macro_define("__UINT16_FMTx__", "\"hx\"");
  cpp_macro_define("__UINT16_FMTX__", "\"hX\"");
  cpp_macro_define("__UINT16_MAX__", "65535");
  cpp_macro_define("__UINT16_TYPE__", "unsigned short");
  cpp_macro_define("__UINT32_C_SUFFIX__", "U");
  cpp_macro_define("__UINT32_FMTo__", "\"o\"");
  cpp_macro_define("__UINT32_FMTu__", "\"u\"");
  cpp_macro_define("__UINT32_FMTx__", "\"x\"");
  cpp_macro_define("__UINT32_FMTX__", "\"X\"");
  cpp_macro_define("__UINT32_MAX__", "4294967295U");
  cpp_macro_define("__UINT32_TYPE__", "unsigned int");
  cpp_macro_define("__UINT64_C_SUFFIX__", "UL");
  cpp_macro_define("__UINT64_FMTo__", "\"lo\"");
  cpp_macro_define("__UINT64_FMTu__", "\"lu\"");
  cpp_macro_define("__UINT64_FMTx__", "\"lx\"");
  cpp_macro_define("__UINT64_FMTX__", "\"lX\"");
  cpp_macro_define("__UINT64_MAX__", "18446744073709551615UL");
  cpp_macro_define("__UINT64_TYPE__", "long unsigned int");
  cpp_macro_define("__UINT8_C_SUFFIX__", "");
  cpp_macro_define("__UINT8_FMTo__", "\"hho\"");
  cpp_macro_define("__UINT8_FMTu__", "\"hhu\"");
  cpp_macro_define("__UINT8_FMTx__", "\"hhx\"");
  cpp_macro_define("__UINT8_FMTX__", "\"hhX\"");
  cpp_macro_define("__UINT8_MAX__", "255");
  cpp_macro_define("__UINT8_TYPE__", "unsigned char");
  cpp_macro_define("__UINT_FAST16_FMTo__", "\"ho\"");
  cpp_macro_define("__UINT_FAST16_FMTu__", "\"hu\"");
  cpp_macro_define("__UINT_FAST16_FMTx__", "\"hx\"");
  cpp_macro_define("__UINT_FAST16_FMTX__", "\"hX\"");
  cpp_macro_define("__UINT_FAST16_MAX__", "65535");
  cpp_macro_define("__UINT_FAST16_TYPE__", "unsigned short");
  cpp_macro_define("__UINT_FAST32_FMTo__", "\"o\"");
  cpp_macro_define("__UINT_FAST32_FMTu__", "\"u\"");
  cpp_macro_define("__UINT_FAST32_FMTx__", "\"x\"");
  cpp_macro_define("__UINT_FAST32_FMTX__", "\"X\"");
  cpp_macro_define("__UINT_FAST32_MAX__", "4294967295U");
  cpp_macro_define("__UINT_FAST32_TYPE__", "unsigned int");
  cpp_macro_define("__UINT_FAST64_FMTo__", "\"lo\"");
  cpp_macro_define("__UINT_FAST64_FMTu__", "\"lu\"");
  cpp_macro_define("__UINT_FAST64_FMTx__", "\"lx\"");
  cpp_macro_define("__UINT_FAST64_FMTX__", "\"lX\"");
  cpp_macro_define("__UINT_FAST64_MAX__", "18446744073709551615UL");
  cpp_macro_define("__UINT_FAST64_TYPE__", "long unsigned int");
  cpp_macro_define("__UINT_FAST8_FMTo__", "\"hho\"");
  cpp_macro_define("__UINT_FAST8_FMTu__", "\"hhu\"");
  cpp_macro_define("__UINT_FAST8_FMTx__", "\"hhx\"");
  cpp_macro_define("__UINT_FAST8_FMTX__", "\"hhX\"");
  cpp_macro_define("__UINT_FAST8_MAX__", "255");
  cpp_macro_define("__UINT_FAST8_TYPE__", "unsigned char");
  cpp_macro_define("__UINT_LEAST16_FMTo__", "\"ho\"");
  cpp_macro_define("__UINT_LEAST16_FMTu__", "\"hu\"");
  cpp_macro_define("__UINT_LEAST16_FMTx__", "\"hx\"");
  cpp_macro_define("__UINT_LEAST16_FMTX__", "\"hX\"");
  cpp_macro_define("__UINT_LEAST16_MAX__", "65535");
  cpp_macro_define("__UINT_LEAST16_TYPE__", "unsigned short");
  cpp_macro_define("__UINT_LEAST32_FMTo__", "\"o\"");
  cpp_macro_define("__UINT_LEAST32_FMTu__", "\"u\"");
  cpp_macro_define("__UINT_LEAST32_FMTx__", "\"x\"");
  cpp_macro_define("__UINT_LEAST32_FMTX__", "\"X\"");
  cpp_macro_define("__UINT_LEAST32_MAX__", "4294967295U");
  cpp_macro_define("__UINT_LEAST32_TYPE__", "unsigned int");
  cpp_macro_define("__UINT_LEAST64_FMTo__", "\"lo\"");
  cpp_macro_define("__UINT_LEAST64_FMTu__", "\"lu\"");
  cpp_macro_define("__UINT_LEAST64_FMTx__", "\"lx\"");
  cpp_macro_define("__UINT_LEAST64_FMTX__", "\"lX\"");
  cpp_macro_define("__UINT_LEAST64_MAX__", "18446744073709551615UL");
  cpp_macro_define("__UINT_LEAST64_TYPE__", "long unsigned int");
  cpp_macro_define("__UINT_LEAST8_FMTo__", "\"hho\"");
  cpp_macro_define("__UINT_LEAST8_FMTu__", "\"hhu\"");
  cpp_macro_define("__UINT_LEAST8_FMTx__", "\"hhx\"");
  cpp_macro_define("__UINT_LEAST8_FMTX__", "\"hhX\"");
  cpp_macro_define("__UINT_LEAST8_MAX__", "255");
  cpp_macro_define("__UINT_LEAST8_TYPE__", "unsigned char");
  cpp_macro_define("__UINTMAX_C_SUFFIX__", "UL");
  cpp_macro_define("__UINTMAX_FMTo__", "\"lo\"");
  cpp_macro_define("__UINTMAX_FMTu__", "\"lu\"");
  cpp_macro_define("__UINTMAX_FMTx__", "\"lx\"");
  cpp_macro_define("__UINTMAX_FMTX__", "\"lX\"");
  cpp_macro_define("__UINTMAX_MAX__", "18446744073709551615UL");
  cpp_macro_define("__UINTMAX_TYPE__", "long unsigned int");
  cpp_macro_define("__UINTMAX_WIDTH__", "64");
  cpp_macro_define("__UINTPTR_FMTo__", "\"lo\"");
  cpp_macro_define("__UINTPTR_FMTu__", "\"lu\"");
  cpp_macro_define("__UINTPTR_FMTx__", "\"lx\"");
  cpp_macro_define("__UINTPTR_FMTX__", "\"lX\"");
  cpp_macro_define("__UINTPTR_MAX__", "18446744073709551615UL");
  cpp_macro_define("__UINTPTR_TYPE__", "long unsigned int");
  cpp_macro_define("__UINTPTR_WIDTH__", "64");
  cpp_macro_define("__unix", "1");
  cpp_macro_define("__unix__", "1");
  cpp_macro_define("unix", "1");
  cpp_macro_define("__USER_LABEL_PREFIX__", "");
  cpp_macro_define("__VERSION__", "\"Ubuntu Clang 19.1.7 (++20250114103238+cd708029e0b2-1~exp1~20250114103342.77)\"");
  cpp_macro_define("__WCHAR_MAX__", "2147483647");
  cpp_macro_define("__WCHAR_TYPE__", "int");
  cpp_macro_define("__WCHAR_WIDTH__", "32");
  cpp_macro_define("__WINT_MAX__", "4294967295U");
  cpp_macro_define("__WINT_TYPE__", "unsigned int");
  cpp_macro_define("__WINT_UNSIGNED__", "1");
