...
/* Error codes */
#define GLOB_NOSPACE                                                           \
  (1) /**< (Error result code:) An attempt to allocate memory failed, or if    \
         errno was 0 GLOB_LIMIT was specified in the flags and ARG_MAX         \
...
#define GLOB_DOOFFS                                                            \
  0x00000008 /**< Insert PGLOB->gl_offs NULLs. Supported from version 1.6 of   \
                UNIXEm. */
#define GLOB_NOCHECK                                                           \
...
#define GLOB_NOESCAPE                                                          \
  0x00000040 /**< Backslashes don't quote metacharacters. Has no effect in     \
...
#define GLOB_MAGCHAR                                                           \
  0x00000100 /**< Set in gl_flags if any metachars seen. Supported from        \
                version 1.6 of UNIXEm. */
/* #define GLOB_ALTDIRFUNC 0x00000200 */ /**< Use gl_opendir et al functions.
                                            Not currently supported in this
                                            implementation. */
#define GLOB_BRACE                                                             \
  0x00000400 /**< Expand "{a,b}" to "a" "b". Not currently supported in this   \
                implementation. */
#define GLOB_NOMAGIC                                                           \
  0x00000800 /**< If no magic chars, return the pattern. Supported from        \
                version 1.6 of UNIXEm. */
#define GLOB_TILDE                                                             \
  0x00001000 /**< Expand ~user and ~ to home directories. Partially supported  \
                from version 1.6 of UNIXEm: leading ~ is expanded to           \
                %HOMEDRIVE%%HOMEPATH%. */
#define GLOB_ONLYDIR                                                           \
  0x00002000 /**< Match only directories. This implementation guarantees to    \
                only return directories when this flag is specified. */
...
#define GLOB_NODOTSDIRS                                                        \
  0x00010000 /**< Elide "." and ".." directories from wildcard searches.       \
                Supported from version 1.6 of UNIXEm. */
#define GLOB_LIMIT                                                             \
  0x00020000 /**< Limits the search to the number specified by the caller in   \
                gl_matchc. Supported from version 1.6 of UNIXEm. */
