 ...
 * @return Negative if `*l` is less than `*r`; zero if `*l` is equal to `*r`;
 ...
 */
void hashmap_init(hashmap* map, size_t capacity, hashmap_comparator comparator, hashmap_hash_func hash_func, hashmap_key_dup_func key_dup_func, hashmap_key_free_func key_free_func);
