...
hmap_print(HMAP_DB* hmap) {
  ...
  for(i = 0; i < hmap->bucket_size; i++) {
    ...
    switch(t->data_type) {
      ...
      case HMAP_DATA_TYPE_INT64: buffer_putlonglong(buffer_1, t->vals.val_int64); break;
      case HMAP_DATA_TYPE_UINT64: buffer_putulonglong(buffer_1, t->vals.val_uint64); break;
