...
int iob_addfile(io_batch* b, fd_type fd, uint64 off, uint64 n);
int iob_addfile_close(io_batch* b, fd_type fd, uint64 off, uint64 n);
int64 iob_send(fd_type sfd, io_batch* b);
