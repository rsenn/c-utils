...
#define IOCTL_SYMLINK_VERSION                                                                      \
  (ULONG) CTL_CODE(FILE_DEVICE_UNKNOWN, 0x00, METHOD_BUFFERED, FILE_ANY_ACCESS)
#define IOCTL_SYMLINK_READ_MEMORY                                                                  \
  (ULONG) CTL_CODE(FILE_DEVICE_UNKNOWN, 0x01, METHOD_BUFFERED, FILE_ANY_ACCESS)
#define IOCTL_SYMLINK_WRITE_MEMORY                                                                 \
  (ULONG) CTL_CODE(FILE_DEVICE_UNKNOWN, 0x02, METHOD_BUFFERED, FILE_ANY_ACCESS)
#define IOCTL_SYMLINK_SETDRIVES                                                                    \
  (ULONG) CTL_CODE(FILE_DEVICE_UNKNOWN, 0x03, METHOD_BUFFERED, FILE_ANY_ACCESS)
#define IOCTL_SYMLINK_UNLOADQUERY                                                                  \
  (ULONG) CTL_CODE(FILE_DEVICE_UNKNOWN, 0x04, METHOD_NEITHER, FILE_ANY_ACCESS)
