...
#define begin(container) \
  _Generic((container), array * : array_start, strarray * : strarray_begin, slist * : slist_begin)(container)
...
#define iterator_dereference(container, it) \
  _Generic((container), array * : array_iterator_dereference, slist * : slist_iterator_dereference)(&it)
