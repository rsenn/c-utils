...
*/
    ...
    defined(__ORANGEC__) || defined(__DMC__) || defined(__STDC_IEC_559__)
#include <stdint.h>
#endif
...
#elif defined(__SSIZE_TYPE__) && !defined(_SSIZE_T_DEFINED) && \
    !defined(_SSIZE_T_)
#define _SSIZE_T_DEFINED 1
#define _SSIZE_T_ 1
typedef __SSIZE_TYPE__ ssize_t;

#elif !defined(MSYS) && defined(__PTRDIFF_TYPE__) && \
    !defined(_SSIZE_T_DEFINED) && !defined(_SSIZE_T_)
#define _SSIZE_T_DEFINED 1
#define _SSIZE_T_ 1
typedef __PTRDIFF_TYPE__ ssize_t;

#elif !(defined(_SYS_TYPES_H) && defined(__MSYS__)) && \
    !defined(_SSIZE_T_DEFINED) && !defined(_SSIZE_T_)
