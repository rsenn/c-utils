...
/*
#if defined(HAVE_INTTYPES_H) || defined(__LCC__) || (!defined(_MSC_VER) && !defined(__MSYS__) &&
!defined(__CYGWIN__) && !defined(__BORLANDC__)) #include <inttypes.h> #endif
...
#elif !defined(MSYS) && defined(__PTRDIFF_TYPE__) && !defined(_SSIZE_T_DEFINED) &&                 \
    !defined(_SSIZE_T_)
#define _SSIZE_T_DEFINED 1
#define _SSIZE_T_ 1
