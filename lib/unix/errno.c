...
static const char* const unix_errnos[] = {
    ...
    "EDEADLK",    "ENAMETOOLONG",  "ENOLCK",          "ENOSYS",          "ENOTEMPTY",    "ELOOP",        "(errno: 41)",
    "ENOMSG",     "EIDRM",         "ECHRNG",          "EL2NSYNC",        "EL3HLT",       "EL3RST",       "ELNRNG",
    "EUNATCH",    "ENOCSI",        "EL2HLT",          "EBADE",           "EBADR",        "EXFULL",       "ENOANO",
    "EBADRQC",    "EBADSLT",       "(errno: 58)",     "EBFONT",          "ENOSTR",       "ENODATA",      "ETIME",
    ...
    "EILSEQ",     "ERESTART",      "ESTRPIPE",        "EUSERS",          "ENOTSOCK",     "EDESTADDRREQ", "EMSGSIZE",
