...
const char* var_get(struct vartab*, const char* v, size_t* offset);
const char* var_setvint(const char* v, int i, int flags);
const char* var_setvsa(const char* name, stralloc* sa, int flags);
const char* var_value(struct vartab*, const char* v, size_t* plen);
const char* var_vdefault(struct vartab*, const char* v, const char* def, size_t* lenp);
