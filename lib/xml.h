...
xmlnodeset xml_find_all_3(
    xmlnode* node, xml_pred_t*, const void* a1, const void* a2, const void* a3);
...
xmlnode* xml_find_parent_pred_3(
    xmlnode* node, xml_pred_t*, const void* a0, const void* a1, const void* a2);
xmlnode* xml_find_parent(xmlnode* node, const char* tag);
xmlnode* xml_find_pred_1(xmlnode* node, xml_pred_t*, const void* arg);
xmlnode*
xml_find_pred_2(xmlnode* node, xml_pred_t*, const void* a0, const void* a1);
...
void xml_print_attributes(
    HMAP_DB* db, buffer* b, const char* sep, const char* eq, const char* quot);
...
xmlnodeset
xml_find_all_3(xmlnode*, xml_pred_t*, const void*, const void*, const void*);
...
xmlnode*
xml_find_parent_pred_2(xmlnode*, xml_pred_t*, const void* a0, const void* a1);
xmlnode* xml_find_parent_pred_3(
    xmlnode*, xml_pred_t*, const void* a0, const void* a1, const void* a2);
