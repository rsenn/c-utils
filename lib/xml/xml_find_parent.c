...
xmlnode*
xml_find_parent_pred_3(xmlnode* node,
                       xml_pred_t* pred,
                       const void* a0,
                       const void* a1,
                       const void* a2) {
