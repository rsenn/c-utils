...
void log_query(uint64*,
               ...
               const char[2]);
void
log_querydone(uint64*, const char[], uint16, int, const char[2], unsigned int);
void log_querydrop(uint64*);
void log_tcpopen(const char[16], unsigned int, int);
void log_tcpclose(const char[16], unsigned int, int);
void
log_tx(const char*, const char[2], const char*, const char[64], unsigned int);
...
void
log_rrmx(const char[16], const char*, const char*, const char[2], unsigned int);
