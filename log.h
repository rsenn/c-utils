...
void log_line(void);
void log_space(void);
void log_ip(const char*, size_t);
void log_iplist(const char*, size_t, size_t);
void log_fd(int);
void log_peer(const char[], uint16, int);
...
void log_tcpopen(const char[], unsigned int, int);
void log_tcpclose(const char[], unsigned int, int);
