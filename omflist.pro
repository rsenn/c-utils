...
lib/buffer/buffer_2.c lib/buffer/buffer_putc.c lib/buffer/buffer_putnspace.c lib/buffer/buffer_putptr.c lib/buffer/buffer_putsa.c lib/buffer/buffer_putspace.c lib/omf/omf_record_begin.c lib/omf/omf_record_end.c lib/omf/omf_record_next.c lib/str/str_diff.c lib/stralloc/stralloc_catc.c lib/stralloc/stralloc_free.c lib/stralloc/stralloc_init.c lib/stralloc/stralloc_zero.c \
lib/byte/byte_fill.c lib/fmt/fmt_xint64.c lib/stralloc/stralloc_ready.c \
