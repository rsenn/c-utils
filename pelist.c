...
#define PE_DUMP_FIELD(base, ptr, st, field) buffer_putspad(b, #field, 30), buffer_puts(b, " 0x"), buffer_putxlonglong0(b, PE_GET(base, ptr, st, field), PE_SIZE(base, st, field) * 2), buffer_putnlflush(b)
...
main(int argc, char** argv) {
  ...
  static const struct longopt opts[] = {
      {"help", 0, NULL, 'h'}, {"imports", 0, &list_imports, 'i'}, {"exports", 0, &list_exports, 'e'}, {"deps", 0, &list_deps, 'd'}, {"sections", 0, &list_sections, 's'}, {"export-directory", 0, &print_export_dir, 'E'}, {"data-directory", 0, &print_data_dir, 'D'}, {"optional-header", 0, &print_opt_header, 'O'}, {"range", 0, &print_range, 'r'}, {"offset-rva", 0, NULL, 'o'}, {"rva-offset", 0, NULL, 'a'}, {"search", 0, NULL, 'S'}, {"rva", 0, &print_as_rva, 'R'}, {0, 0, 0, 0}};
