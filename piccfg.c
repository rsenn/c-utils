...
main(int argc, char* argv[]) {
  ...
  struct unix_longopt opts[] = {
      {"help", 0, NULL, 'h'}, {"oneline", 0, &oneline, 1}, {"no-default", 0, &nodefault, 1}, {"default", 0, &nodefault, 0}, {"no-comments", 0, &comments, 0}, {"name", 0, &output_name, 1}, {"verbose", 0, &verbose, 1}, {0, 0, 0, 0}};
