...
usage(char* av0) {
  buffer_putm_internal(buffer_1,
                       ...
                       "  -c, --escape-c                   Escape characters for C                        trings\n"
                       "  -C, --escape-cmake               Escape characters for CMake                        trings\n"
                       "  -S, --escape-shell               Escape characters for shell                        trings\n"
                       "  -D, --escape-doublequoted-shell  Escape characters for                        ouble-quoted shell strings\n"
                       "  -Q, --escape-quoted-shell        Escape characters for                        ingle-quoted shell strings\n"
                       "  -X, --escape-xml                 Escape characters for XML\n"
                       "  -J, --escape-json                Escape characters for JSON\n"
                       "  -P, --escape-printable           Escape non-printable                        haracters\n"
