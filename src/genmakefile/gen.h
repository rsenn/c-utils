...
target* gen_simple_compile_rules(sourcedir*, const char*, const char* fromext, const char* toext, stralloc* cmd, char pathsep_args);
target* gen_single_rule(stralloc*, stralloc*);
target* gen_srcdir_compile_rules(sourcedir*, const char*, bool shell, bool batch, bool batchmode, char pathsep_args, char pathsep_make);
target* gen_srcdir_lib_rule(sourcedir*, const char*, bool shell, bool batch, bool batchmode, char pathsep_args, char pathsep_make);
