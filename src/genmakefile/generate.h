...
void add_path_sa(set_t* s, stralloc* path);
...
target* generate_srcdir_compile_rules(sourcedir* srcdir,
                                      const char* dir,
                                      bool shell,
                                      bool batch,
                                      bool batchmode,
                                      char psa,
                                      char psm);
target* generate_simple_compile_rules(sourcedir* srcdir,
                                      const char* dir,
                                      const char* fromext,
                                      const char* toext,
                                      stralloc* cmd,
                                      char psa);
target* generate_srcdir_lib_rule(sourcedir* srcdir,
                                 const char* name,
                                 bool shell,
                                 bool batch,
                                 bool batchmode,
                                 char psa,
                                 char psm);
void generate_srcdir_rule(sourcedir* sdir,
                          const char* name,
                          bool batchmode,
                          char psm);
void generate_lib_rules(
