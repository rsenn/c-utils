...
xmlnode* alternate_loadable_file = xml_child_element("alternateLoadableFile", loading) xmlnode* subordinates = xml_child_element("subordinates", compile_type) xmlnode* make_customization_type =
...
xml_child_element("targetDevice", tools_set)->children = xml_textnode("PIC18F2550");
target_header = xml_child_element("targetHeader", tools_set) target_plugin_board = xml_child_element("targetPluginBoard", tools_set) xml_child_element("platformTool", tools_set)->children =
