xmlnode* configuration_descriptor = xml_element("configurationDescriptor") configuration_descriptor->attributes =
    xml_attributes("version", "65", 0);
xmlnode* logical_folder = xml_child_element("logicalFolder", configuration_descriptor) logical_folder->attributes =
...
xmlnode* confs = xml_child_element("confs", configuration_descriptor) xmlnode* conf =
    xml_child_element("conf", confs) conf->attributes = xml_attributes("name", "release", "type", "2", 0);
xmlnode* tools_set = xml_child_element("toolsSet", conf) xml_child_element("developmentServer", tools_set)->children =
    xml_textnode("localhost");
...
xmlnode* compile_type = xml_child_element("compileType", conf) xmlnode* linker_tool = xml_child_element(
    "linkerTool", compile_type) xmlnode* linker_lib_items = xml_child_element("linkerLibItems", linker_tool)
    xmlnode* archiver_tool = xml_child_element("archiverTool", compile_type) xmlnode* loading =
        xml_child_element("loading", compile_type) xml_child_element("useAlternateLoadableFile", loading)->children =
            xml_textnode("false");
...
property = xml_child_element("property", pickit3platform_tool) property->attributes = xml_attributes(
...
tools_set = xml_child_element("toolsSet", conf) xml_child_element("developmentServer", tools_set)->children =
    xml_textnode("localhost");
xml_child_element("targetDevice", tools_set)->children = xml_textnode("PIC18F2550");
...
packs = xml_child_element("packs", conf) pack = xml_child_element("pack", packs) pack->attributes =
    xml_attributes("name", "PIC18Fxxxx_DFP", "vendor", "Microchip", "version", "1.1.19", 0);
compile_type = xml_child_element("compileType", conf) linker_tool = xml_child_element("linkerTool",
                                                                                      compile_type) linker_lib_items =
    xml_child_element("linkerLibItems", linker_tool) archiver_tool = xml_child_element("archiverTool",
                                                                                       compile_type) loading =
        xml_child_element("loading", compile_type) xml_child_element("useAlternateLoadableFile", loading)->children =
            xml_textnode("false");
xml_child_element("parseOnProdLoad", loading)->children = xml_textnode("false");
