...
xmlnode* target_header = xml_child_element("targetHeader", tools_set) xmlnode* target_plugin_board = xml_child_element("targetPluginBoard", tools_set) xml_child_element("platformTool", tools_set)->children = xml_textnode("PICkit3PlatformTool");
...
xmlnode* compile_type = xml_child_element("compileType", conf) xmlnode* linker_tool = xml_child_element("linkerTool", compile_type) xmlnode* linker_lib_items = xml_child_element("linkerLibItems", linker_tool) xmlnode* archiver_tool = xml_child_element("archiverTool", compile_type) xmlnode* loading =
    xml_child_element("loading", compile_type) xml_child_element("useAlternateLoadableFile", loading)->children = xml_textnode("false");
xml_child_element("parseOnProdLoad", loading)->children = xml_textnode("false");
xmlnode* alternate_loadable_file = xml_child_element("alternateLoadableFile", loading) xmlnode* subordinates = xml_child_element("subordinates", compile_type) xmlnode* make_customization_type = xml_child_element("makeCustomizationType", conf) xml_child_element("makeCustomizationPreStepEnabled", make_customization_type)->children = xml_textnode("false");
xmlnode* make_customization_pre_step = xml_child_element("makeCustomizationPreStep", make_customization_type) xml_child_element("makeCustomizationPostStepEnabled", make_customization_type)->children = xml_textnode("false");
xmlnode* make_customization_post_step = xml_child_element("makeCustomizationPostStep", make_customization_type) xml_child_element("makeCustomizationPutChecksumInUserID", make_customization_type)->children = xml_textnode("false");
...
property = xml_child_element("property", hitechcomp) property->attributes = xml_attributes("key", "extra-include-directories", "value", "../../../src;../../../lib;../../..", 0);
...
property = xml_child_element("property", hitechlink) property->attributes = xml_attributes("key", "additional-options-code-offset", "value", "", 0);
property = xml_child_element("property", hitechlink) property->attributes = xml_attributes("key", "additional-options-command-line", "value", "", 0);
property = xml_child_element("property", hitechlink) property->attributes = xml_attributes("key", "additional-options-errata", "value", "", 0);
property = xml_child_element("property", hitechlink) property->attributes = xml_attributes("key", "additional-options-extend-address", "value", "false", 0);
...
property = xml_child_element("property", hitechlink) property->attributes = xml_attributes("key", "additional-options-use-response-files", "value", "false", 0);
...
property = xml_child_element("property", hitechlink) property->attributes = xml_attributes("key", "program-the-device-with-default-config-words", "value", "true", 0);
...
property = xml_child_element("property", pickit3platform_tool) property->attributes = xml_attributes("key", "SecureSegment.SegmentProgramming", "value", "FullChipProgramming", 0);
property = xml_child_element("property", pickit3platform_tool) property->attributes = xml_attributes("key", "ToolFirmwareFilePath", "value", "Press to browse for a specific firmware version", 0);
property = xml_child_element("property", pickit3platform_tool) property->attributes = xml_attributes("key", "ToolFirmwareOption.UseLatestFirmware", "value", "true", 0);
...
property = xml_child_element("property", pickit3platform_tool) property->attributes = xml_attributes("key", "memories.instruction.ram.ranges", "value", "${memories.instruction.ram.ranges}", 0);
...
property = xml_child_element("property", pickit3platform_tool) property->attributes = xml_attributes("key", "programoptions.donoteraseauxmem", "value", "false", 0);
...
property = xml_child_element("property", pickit3platform_tool) property->attributes = xml_attributes("key", "programoptions.preservedataflash", "value", "false", 0);
property = xml_child_element("property", pickit3platform_tool) property->attributes = xml_attributes("key", "programoptions.preservedataflash.ranges", "value", "${programoptions.preservedataflash.ranges}", 0);
...
property = xml_child_element("property", pickit3platform_tool) property->attributes = xml_attributes("key", "programoptions.preserveeeprom.ranges", "value", "0-ff", 0);
property = xml_child_element("property", pickit3platform_tool) property->attributes = xml_attributes("key", "programoptions.preserveprogram.ranges", "value", "", 0);
property = xml_child_element("property", pickit3platform_tool) property->attributes = xml_attributes("key", "programoptions.preserveprogramrange", "value", "false", 0);
...
property = xml_child_element("property", pickit3platform_tool) property->attributes = xml_attributes("key", "programoptions.testmodeentrymethod", "value", "VDDFirst", 0);
property = xml_child_element("property", pickit3platform_tool) property->attributes = xml_attributes("key", "programoptions.usehighvoltageonmclr", "value", "false", 0);
property = xml_child_element("property", pickit3platform_tool) property->attributes = xml_attributes("key", "programoptions.uselvpprogramming", "value", "false", 0);
...
compile_type = xml_child_element("compileType", conf) linker_tool = xml_child_element("linkerTool", compile_type) linker_lib_items = xml_child_element("linkerLibItems", linker_tool) archiver_tool = xml_child_element("archiverTool", compile_type) loading = xml_child_element("loading", compile_type) xml_child_element("useAlternateLoadableFile", loading)->children = xml_textnode("false");
xml_child_element("parseOnProdLoad", loading)->children = xml_textnode("false");
alternate_loadable_file = xml_child_element("alternateLoadableFile", loading) subordinates = xml_child_element("subordinates", compile_type) make_customization_type = xml_child_element("makeCustomizationType", conf) xml_child_element("makeCustomizationPreStepEnabled", make_customization_type)->children = xml_textnode("false");
make_customization_pre_step = xml_child_element("makeCustomizationPreStep", make_customization_type) xml_child_element("makeCustomizationPostStepEnabled", make_customization_type)->children = xml_textnode("false");
make_customization_post_step = xml_child_element("makeCustomizationPostStep", make_customization_type) xml_child_element("makeCustomizationPutChecksumInUserID", make_customization_type)->children = xml_textnode("false");
xml_child_element("makeCustomizationEnableLongLines", make_customization_type)->children = xml_textnode("false");
xml_child_element("makeCustomizationNormalizeHexFile", make_customization_type)->children = xml_textnode("false");
