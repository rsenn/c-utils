xmlnode* configuration_descriptor =
    xml_element("configurationDescriptor") configuration_descriptor->attributes =
        xml_attributes("version", "65", 0);
xmlnode* logical_folder =
    xml_child_element("logicalFolder", configuration_descriptor) logical_folder->attributes =
...
logical_fo1 = xml_child_element("logicalFolder", logical_folder) logical_fo1->attributes =
    xml_attributes(
        "name", "LinkerScript", "displayName", "Linker Files", "projectFiles", "true", 0);
logical_fo1 = xml_child_element("logicalFolder", logical_folder) logical_fo1->attributes =
...
xmlnode* confs = xml_child_element("confs", configuration_descriptor) xmlnode* conf =
    xml_child_element("conf", confs) conf->attributes =
...
xmlnode* target_header = xml_child_element("targetHeader", tools_set) xmlnode* target_plugin_board =
    xml_child_element("targetPluginBoard", tools_set) xml_child_element("platformTool", tools_set)
...
xmlnode* compile_type = xml_child_element("compileType", conf) xmlnode* linker_tool =
        ...
        xml_child_element("linkerLibItems", linker_tool) xmlnode* archiver_tool =
            xml_child_element("archiverTool", compile_type) xmlnode* loading =
                xml_child_element("loading", compile_type)
                    xml_child_element("useAlternateLoadableFile", loading)
    ...
    xml_child_element("alternateLoadableFile", loading) xmlnode* subordinates =
        xml_child_element("subordinates", compile_type) xmlnode* make_customization_type =
            xml_child_element("makeCustomizationType", conf)
                xml_child_element("makeCustomizationPreStepEnabled", make_customization_type)
                    ->children = xml_textnode("false");
xmlnode* make_customization_pre_step =
    xml_child_element("makeCustomizationPreStep", make_customization_type)
        xml_child_element("makeCustomizationPostStepEnabled", make_customization_type)
            ->children = xml_textnode("false");
xmlnode* make_customization_post_step =
    xml_child_element("makeCustomizationPostStep", make_customization_type)
        xml_child_element("makeCustomizationPutChecksumInUserID", make_customization_type)
            ->children = xml_textnode("false");
xml_child_element("makeCustomizationEnableLongLines", make_customization_type)->children =
    xml_textnode("false");
xml_child_element("makeCustomizationNormalizeHexFile", make_customization_type)->children =
    xml_textnode("false");
xmlnode* hitechcomp = xml_child_element("HI-TECH-COMP", conf) xmlnode* property =
...
property = xml_child_element("property", hitechcomp) property->attributes =
    xml_attributes("key",
                   "define-macros",
                   "value",
                   "__XC=1;__18f2550=1;USE_SER=1;USE_HD44780_LCD=1;_XTAL_FREQ=20000000;BAUD_RATE="
                   "38400;USE_TIMER0=1;"
                   "MCHP_XC8=1;NDEBUG=1",
                   0);
property = xml_child_element("property", hitechcomp) property->attributes =
    xml_attributes("key", "disable-optimizations", "value", "false", 0);
property = xml_child_element("property", hitechcomp) property->attributes = xml_attributes(
    "key", "extra-include-directories", "value", "../../../src;../../../lib;../../..", 0);
property = xml_child_element("property", hitechcomp) property->attributes =
...
xmlnode* append_me = xml_child_element("appendMe", hitechcomp) append_me->attributes =
...
property = xml_child_element("property", pickit3platform_tool)
    ...
    "key", "ToolFirmwareFilePath", "value", "Press to browse for a specific firmware version", 0);
property = xml_child_element("property", pickit3platform_tool) property->attributes =
...
property = xml_child_element("property", pickit3platform_tool) property->attributes =
    xml_attributes(
        "key", "memories.instruction.ram.ranges", "value", "${memories.instruction.ram.ranges}", 0);
property = xml_child_element("property", pickit3platform_tool) property->attributes =
...
tools_set = xml_child_element("toolsSet", conf) xml_child_element("developmentServer", tools_set)
                ->children = xml_textnode("localhost");
xml_child_element("targetDevice", tools_set)->children = xml_textnode("PIC18F2550");
target_header = xml_child_element("targetHeader", tools_set) target_plugin_board =
    xml_child_element("targetPluginBoard", tools_set) xml_child_element("platformTool", tools_set)
        ->children = xml_textnode("PICkit3PlatformTool");
xml_child_element("languageToolchain", tools_set)->children = xml_textnode("XC8");
xml_child_element("languageToolchainVersion", tools_set)->children = xml_textnode("1.45");
xml_child_element("platform", tools_set)->children = xml_textnode("2");
packs = xml_child_element("packs", conf) pack = xml_child_element("pack", packs) pack->attributes =
    xml_attributes("name", "PIC18Fxxxx_DFP", "vendor", "Microchip", "version", "1.1.19", 0);
...
property = xml_child_element("property", hitechcomp) property->attributes =
    xml_attributes("key",
                   "define-macros",
                   "value",
                   "__XC=1;__18f2550=1;USE_TIMER1=1;USE_TIMER2=1;USE_SER=1;USE_HD44780_LCD=1;XTAL_"
                   "FREQ=16000000;BAUD_"
