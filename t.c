...
xmlnode* confs = xml_child_element("confs", configuration_descriptor) xmlnode* conf = xml_child_element("conf", confs) conf->attributes =
...
xmlnode* target_header = xml_child_element("targetHeader", tools_set) xmlnode* target_plugin_board =
    xml_child_element("targetPluginBoard", tools_set) xml_child_element("platformTool", tools_set)->children = xml_textnode("PICkit3PlatformToo"
                                                                                                                            "l");
...
xmlnode* hitechlink = xml_child_element("HI-TECH-LINK", conf) property = xml_child_element("property", hitechlink) property->attributes =
...
target_header = xml_child_element("targetHeader", tools_set) target_plugin_board =
    xml_child_element("targetPluginBoard", tools_set) xml_child_element("platformTool", tools_set)->children = xml_textnode("PICkit3PlatformTool");
xml_child_element("languageToolchain", tools_set)->children = xml_textnode("XC8");
xml_child_element("languageToolchainVersion", tools_set)->children = xml_textnode("1.45");
xml_child_element("platform", tools_set)->children = xml_textnode("2");
packs = xml_child_element("packs", conf) pack = xml_child_element("pack", packs) pack->attributes =
    xml_attributes("name", "PIC18Fxxxx_DFP", "vendor", "Microchip", "version", "1.1.19", 0);
compile_type = xml_child_element("compileType", conf) linker_tool = xml_child_element("linkerTool", compile_type) linker_lib_items =
    xml_child_element("linkerLibItems", linker_tool) archiver_tool = xml_child_element("archiverTool", compile_type) loading =
...
xml_child_element("makeCustomizationEnableLongLines", make_customization_type)->children = xml_textnode("false");
xml_child_element("makeCustomizationNormalizeHexFile", make_customization_type)->children = xml_textnode("false");
hitechcomp = xml_child_element("HI-TECH-COMP", conf) property = xml_child_element("property", hitechcomp) property->attributes =
    xml_attributes("key", "additional-warnings", "value", "true", 0);
property = xml_child_element("property", hitechcomp) property->attributes = xml_attributes("key", "asmlist", "value", "true", 0);
property = xml_child_element("property", hitechcomp) property->attributes = xml_attributes("key", "default-bitfield-type", "value", "true", 0);
property = xml_child_element("property", hitechcomp) property->attributes = xml_attributes("key", "default-char-type", "value", "true", 0);
...
hitechlink = xml_child_element("HI-TECH-LINK", conf) property = xml_child_element("property", hitechlink) property->attributes =
    xml_attributes("key", "additional-options-checksum", "value", "", 0);
property = xml_child_element("property", hitechlink) property->attributes = xml_attributes("key",
                                                                                           "additional-options-"
                                                                                           "code-offset",
