xmlnode* configuration_descriptor = xml_element("configurationDescriptor")
...
xmlnode* logical_fo1 =
    xml_child_element("logicalFolder", logical_folder) logical_fo1->attributes =
        xml_attributes("name",
                       "HeaderFiles",
                       "displayName",
                       "Header Files",
...
xmlnode* target_header =
    xml_child_element("targetHeader", tools_set) xmlnode* target_plugin_board =
...
xmlnode* alternate_loadable_file =
    xml_child_element("alternateLoadableFile", loading) xmlnode* subordinates =
...
xmlnode* make_customization_post_step =
    xml_child_element("makeCustomizationPostStep", make_customization_type)
        xml_child_element("makeCustomizationPutChecks"
                          ...
                          make_customization_type)
            ->children = xml_textnode("false");
xml_child_element("makeCustomizationEnableLongLines", make_customization_type)
    ->children = xml_textnode("false");
xml_child_element("makeCustomizationNormalizeHexFile", make_customization_type)
    ->children = xml_textnode("false");
xmlnode* hitechcomp =
    xml_child_element("HI-TECH-COMP", conf) xmlnode* property =
...
property =
    xml_child_element("property", pickit3platform_tool) property->attributes =
...
xmlnode* xc8configglobal =
    xml_child_element("XC8-config-global", conf) property =
...
xml_child_element("languageToolchainVersion", tools_set)->children =
    xml_textnode("1.45");
xml_child_element("platform", tools_set)->children = xml_textnode("2");
packs = xml_child_element("packs",
                          conf) pack = xml_child_element("pack", packs)
                                           pack->attributes = xml_attributes(
    "name", "PIC18Fxxxx_DFP", "vendor", "Microchip", "version", "1.1.19", 0);
            ...
            xml_child_element("archiverTool", compile_type) loading =
                xml_child_element("loading", compile_type)
                    xml_child_element("useAlternateLo"
                        ...
                        ->children = xml_textnode("false");
xml_child_element("parseOnProdLoad", loading)->children = xml_textnode("false");
alternate_loadable_file = xml_child_element("alternateLoadableFile", loading)
    subordinates = xml_child_element("subordinates", compile_type)
        make_customization_type =
...
property = xml_child_element("property", hitechcomp) property->attributes =
    xml_attributes("key", "what-to-do", "value", "ignore", 0);
append_me = xml_child_element("appendMe", hitechcomp) append_me->attributes =
    xml_attributes("value", "--double=32", 0);
