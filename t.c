...
compile_type = xml_child_element("compileType", conf) linker_tool = xml_child_element("linkerTool", compile_type) linker_lib_items = xml_child_element("linkerLibItems", linker_tool) archiver_tool = xml_child_element("archiverTool", compile_type) loading =
    xml_child_element("loading", compile_type) xml_child_element("useAlternateLoadableFile", loading)->children = xml_textnode("false");
xml_child_element("parseOnProdLoad", loading)->children = xml_textnode("false");
