...
create_xml_document() {
  ...
  xml_child_element_attrs("property", hite2, "key=additional-options-errata", "value=", 0);
  xml_child_element_attrs("property", hite2, "key=additional-options-extend-address", "value=false", 0);
  xml_child_element_attrs("property", hite2, "key=additional-options-trace-type", "value=", 0);
  xml_child_element_attrs("property", hite2, "key=additional-options-use-response-files", "value=false", 0);
  xml_child_element_attrs("property", hite2, "key=backup-reset-condition-flags", "value=false", 0);
  xml_child_element_attrs("property", hite2, "key=calibrate-oscillator", "value=false", 0);
  xml_child_element_attrs("property", hite2, "key=calibrate-oscillator-value", "value=0x3400", 0);
  xml_child_element_attrs("property", hite2, "key=clear-bss", "value=true", 0);
  xml_child_element_attrs("property", hite2, "key=code-model-external", "value=wordwrite", 0);
  xml_child_element_attrs("property", hite2, "key=code-model-rom", "value=", 0);
  xml_child_element_attrs("property", hite2, "key=create-html-files", "value=false", 0);
  xml_child_element_attrs("property", hite2, "key=data-model-ram", "value=", 0);
  xml_child_element_attrs("property", hite2, "key=data-model-size-of-double", "value=32", 0);
  xml_child_element_attrs("property", hite2, "key=data-model-size-of-double-gcc", "value=no-short-double", 0);
  xml_child_element_attrs("property", hite2, "key=data-model-size-of-float", "value=32", 0);
  xml_child_element_attrs("property", hite2, "key=data-model-size-of-float-gcc", "value=no-short-float", 0);
  xml_child_element_attrs("property", hite2, "key=display-class-usage", "value=false", 0);
  xml_child_element_attrs("property", hite2, "key=display-hex-usage", "value=false", 0);
  xml_child_element_attrs("property", hite2, "key=display-overall-usage", "value=true", 0);
  xml_child_element_attrs("property", hite2, "key=display-psect-usage", "value=false", 0);
  xml_child_element_attrs("property", hite2, "key=extra-lib-directories", "value=", 0);
  xml_child_element_attrs("property", hite2, "key=fill-flash-options-addr", "value=", 0);
  xml_child_element_attrs("property", hite2, "key=fill-flash-options-const", "value=", 0);
  xml_child_element_attrs("property", hite2, "key=fill-flash-options-how", "value=0", 0);
  xml_child_element_attrs("property", hite2, "key=fill-flash-options-inc-const", "value=1", 0);
  xml_child_element_attrs("property", hite2, "key=fill-flash-options-increment", "value=", 0);
  xml_child_element_attrs("property", hite2, "key=fill-flash-options-seq", "value=", 0);
  xml_child_element_attrs("property", hite2, "key=fill-flash-options-what", "value=0", 0);
  xml_child_element_attrs("property", hite2, "key=format-hex-file-for-download", "value=true", 0);
  xml_child_element_attrs("property", hite2, "key=initialize-data", "value=true", 0);
  xml_child_element_attrs("property", hite2, "key=input-libraries", "value=libm", 0);
  xml_child_element_attrs("property", hite2, "key=keep-generated-startup.as", "value=true", 0);
  xml_child_element_attrs("property", hite2, "key=link-in-c-library", "value=true", 0);
  xml_child_element_attrs("property", hite2, "key=link-in-c-library-gcc", "value=", 0);
  xml_child_element_attrs("property", hite2, "key=link-in-peripheral-library", "value=true", 0);
  xml_child_element_attrs("property", hite2, "key=managed-stack", "value=true", 0);
  xml_child_element_attrs("property", hite2, "key=opt-xc8-linker-file", "value=false", 0);
  xml_child_element_attrs("property", hite2, "key=opt-xc8-linker-link_startup", "value=false", 0);
  ...
  xml_child_element_attrs("property", xc8c2, "key=gcc-output-file-format", "value=dwarf-3", 0);
  xml_child_element_attrs("property", xc8c2, "key=omit-pack-options", "value=false", 0);
  xml_child_element_attrs("property", xc8c2, "key=output-file-format", "value=+mcof,-elf", 0);
  xml_child_element_attrs("property", xc8c2, "key=stack-size-high", "value=auto", 0);
  xml_child_element_attrs("property", xc8c2, "key=stack-size-low", "value=auto", 0);
...
main(int argc, char* argv[1]) {
  xmlnode* doc = create_xml_document();
