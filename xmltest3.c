...
create_xml_document() {
  ...
  configuration_descriptor->attributes = xml_attributes(
    "version", "65",
  0);
    ...
    confs = xml_child_element("confs", configuration_descriptor);
      ...
      conf->attributes = xml_attributes(
        "name", "debug",
        "type", "2",
      0);
        ...
        hitechcomp = xml_child_element("HI-TECH-COMP", conf);
          ...
          xml_child_element_attrs("property", hitechcomp, "key", "define-macros", "value", "__18f2550=1;XTAL_FREQ=20000000;UART_BAUD=38400;USE_TIMER0=1;USE_TIMER1=1;USE_TIMER2=1;USE_SOFTPWM=1;USE_SOFTSER=1;HAVE_COMPARATOR=1", 0);
          xml_child_element_attrs("property", hitechcomp, "key", "disable-optimizations", "value", "false", 0);
          xml_child_element_attrs("property", hitechcomp, "key", "extra-include-directories", "value", "../../..;../../../lib;../../../src", 0);
