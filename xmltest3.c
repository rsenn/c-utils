...
xmlnode*
create_xml_document() {
  xmlnode *compile_type, *conf, *configuration_descriptor, *confs, *doc,
      *hitechcomp, *linker_tool, *loading, *logical_folder, *logical_folder1,
      *logical_folder2, *logical_folder3, *make_customization_type, *packs,
      *source_root_list, *tools_set;

  doc = xml_newnode(XML_DOCUMENT);
  configuration_descriptor = doc->children =
  ...
  logical_folder->attributes = xml_attributes("name",
                                              "SourceFiles",
                                              "displayName",
                                              "Source Files",
                                              "projectFiles",
  ...
  xml_child_element_text("itemPath",
                         logical_folder2,
                         "../../../lib/comparator.c");
  ...
  xml_child_element_text("projectmakefile",
  ...
  xml_child_element_text("makeCustomizationPreStepEnabled",
  ...
  xml_child_element_attrs(
      "property", hitechcomp, "key", "additional-warnings", "value", "true", 0);
  xml_child_element_attrs(
      "property", hitechcomp, "key", "asmlist", "value", "true", 0);
  xml_child_element_attrs("property",
                          ...
                          0);
  xml_child_element_attrs(
      "property", hitechcomp, "key", "default-char-type", "value", "true", 0);
  xml_child_element_attrs("property",
                          hitechcomp,
                          "key",
                          "define-macros",
  ...
  xml_child_element_attrs("property",
                          ...
                          0);
  xml_child_element_attrs(
      "property", hitechcomp, "key", "identifier-length", "value", "255", 0);
  xml_child_element_attrs(
      "property", hitechcomp, "key", "local-generation", "value", "false", 0);
  xml_child_element_attrs(
      "property", hitechcomp, "key", "operation-mode", "value", "pro", 0);
  xml_child_element_attrs("property",
                          hitechcomp,
                          "key",
                          "opt-xc8-compiler-strict_ansi",
                          "value",
                          "false",
                          0);
  xml_child_element_attrs("property",
  ...
  xml_child_element_attrs("property",
                          hitechcomp,
                          "key",
                          "optimization-assembler-files",
                          "value",
                          "true",
                          0);
  xml_child_element_attrs(
      "property", hitechcomp, "key", "optimization-debug", "value", "true", 0);
  xml_child_element_attrs("property",
                          hitechcomp,
                          "key",
                          "optimization-invariant-enable",
                          "value",
                          "false",
                          0);
  xml_child_element_attrs("property",
                          hitechcomp,
                          "key",
                          "optimization-invariant-value",
                          "value",
                          "16",
                          0);
  xml_child_element_attrs(
      "property", hitechcomp, "key", "optimization-level", "value", "-Os", 0);
  xml_child_element_attrs(
      "property", hitechcomp, "key", "optimization-speed", "value", "false", 0);
  xml_child_element_attrs("property",
                          hitechcomp,
                          "key",
                          "optimization-stable-enable",
                          "value",
                          "false",
                          0);
  xml_child_element_attrs(
      "property", hitechcomp, "key", "pack-struct", "value", "true", 0);
  xml_child_element_attrs("property",
                          hitechcomp,
                          "key",
                          ...
                          0);
  xml_child_element_attrs(
      "property", hitechcomp, "key", "short-enums", "value", "true", 0);
  xml_child_element_attrs(
      "property", hitechcomp, "key", "undefine-macros", "value", "", 0);
